...
shinyUI(fluidPage(
  ...
  sidebarPanel(
    ...
    radioButtons("radio",
                 h5("Smoothing"),
                 choices = list("Stupid Kick-off" = 1, "Kneser-Ney " = 2),
                 selected = 1),
    submitButton("SUBMIT"),
    br(),
    
    "This app is created by ",
    a("Dineshkumar Murugan", href = "dineshmuruganc@gmail.com"),
    p(strong(em("Github repository:",a("A John Hopkins University - Capstone Project",href="https://github.com/DINESHKUMARMURUGAN"))))
  ),
  mainPanel(
